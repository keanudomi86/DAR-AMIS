...
INSERT INTO `form_repo` VALUES (19,37,13,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL),(21,38,14,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL),(22,39,15,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL),(30,48,17,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL),(31,58,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(32,59,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(33,60,19,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `par` (
  ...
  `received_office` int(11) DEFAULT NULL,
  ...
  KEY `fk_office_par_idx` (`received_office`),
  CONSTRAINT `fk_office_par` FOREIGN KEY (`received_office`) REFERENCES `office` (`id_office`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `par` VALUES (5,0,NULL,NULL,'543757','dfjhh6yh','gduhd','fghdfghd',4,'2011-11-12','cxvbfdb','sdfg','sdfgfdsg','2018-11-13'),(6,0,NULL,NULL,'543757','dfjhh6yh','gduhd','fghdfghd',4,'2011-11-12','cxvbfdb','sdfg','sdfgfdsg','2018-11-13');
...
CREATE TABLE `par_details` (
  ...
  UNIQUE KEY `id_par_UNIQUE` (`id_par`),
  CONSTRAINT `fk_par_details_par` FOREIGN KEY (`id_par`) REFERENCES `par` (`id_par`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `po_details` VALUES (8,13,12,'Chair','for sitting',40,250,10000),(9,14,13,'Libertad Street','for surface',40,500,20000),(10,15,14,'Table','for surface',50,500,25000),(13,17,25,'Chair','for sitting',5,500,2500),(14,17,26,'shelf','for surface',9,700,6300),(15,17,27,'Desk','for surface',8,600,4800),(16,18,3023,'chairadsfs','asdasdasdfsdf',124,123,1477480);
...
INSERT INTO `pr_details` VALUES (12,37,0,'Chair','for sitting',40,0,0,'','',''),(13,38,0,'Desk','for surface',40,0,0,'','',''),(14,39,0,'Table','for surface',50,0,0,'','',''),(25,48,0,'Chair','for sitting',5,0,0,'','',''),(26,48,0,'shelf','for surface',9,0,0,'','',''),(27,48,0,'desk','for surface',8,0,0,'','',''),(28,58,0,'sdfsadf','scfdgf',123,123,123,'fsdagsdfg','sadfdsf','asdfasdf'),(29,59,0,'chair','sdasd',12,2323,123123,'qweqwe','Rene','Director'),(30,60,0,'chair','asdasd',12,123,123123,'qweqwe','Rene','Director');
...
-- Dump completed on 2018-08-01 13:16:50
