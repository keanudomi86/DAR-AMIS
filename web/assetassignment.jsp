<%-- 
    Document   : assetassignment
    Created on : 03 23, 18, 11:05:20 AM
...
<html lang="en">
  <head>
    ...
    <title>DAR-AMIS | Asset Assignment</title>
    <style>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <div class="panel panel-default">
    	               ...
    	               <div class="btn-group">
    	                <button class="btn btn-secondary dropdown-toggle" type="button" data-toggle="dropdown" id="reports"> 
    	                  ...
    	                  <ul class="dropdown-menu">
    	                    <li><a class="dropdown-item" id="1" href="#" >Asset Assignment</a></li>    	                       
    	                  </ul>
    	              </div>
    	              </div> 
            ...
            <div class = "panel-heading panel-heading-custom">
              <div class= "row">
                 <div class="col-sm-2"><label align= "text-center" id="one">Employee Name</label></div>
