...
<html lang="en">
  <head>
    ...
    <script>
        function submitPPMP(){
            alert($("[name='ppmpForm']").serialize());
            
            if(confirm("Submit form?"))
            {
                $.post("<%=root%>/CreatePPMP", $("[name='ppmpForm']").serialize(), function(data){
                    alert(data);
                });
            }
        }
       ...
       <section id="main-content">
          <section class="wrapper">
              <section class="content-header">
                    <h1>Project Procurement and Management Plan</h1>
                    ...
                    <div class="panel panel-default">
                      ...
                      <div>
                            <form name="ppmpForm">
                              ...
                              <!-- P3 -->
                           <p class="text-center"><button class="btn btn-default" onclick="submitPPMP()">Submit</button></p>         
                     </div>         
                </div>
		</section><! --/wrapper -->
      </section>
