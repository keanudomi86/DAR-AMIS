                                    ...
                                    <table id="myTable" class="table order-list">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <div><input type="text"  name="quantity" class="qty" id="qty0" align= "text-center" placeholder="Quantity"></div>
                                                </td>
                                                <td>
                                                    <div><input type="text"  name="unitCost" class="unit" id="unit0" align= "text-center" placeholder="Unit Cost"></div>
                                                </td>
                                                <td>
                                                    <div><input type="text"  name="totalCost" class="line" id="line0" align= "text-center" placeholder="Total Cost"></div>
                                                </td>
                                                <td>
                                                    <a class="deleteRow"></a>
                                                </td>
                                    ...
                                    <script>
                                        $(document).ready(function () {
                                            ...
                                            $("#addrow").on("click", function () {
                                                ...
                                                cols += '<td><div><input type="text" class="qty"  name="quantity" align= "text-center" id="qty' + counter + '" placeholder="Quantity"></td>';
                                                cols += '<td><div><input type="text" class="unit"  name="cost" align= "text-center" id="unit' + counter + '" placeholder="Unit Cost"></div></td>';
                                                cols += '<td><div><input type="text" class="line"  name="totalCost" align= "text-center" id="total' + counter + '" placeholder="Total Cost"></div></td>';
                                            ...
                                            $('.unit').on('change', function(event) {
                                                console.log(event.target.id.split('t')[1]);
                                            });
