<%-- 
    Document   : assetlocation
    Created on : 03 23, 18, 11:09:10 AM
...
<html lang="en">
  <head>
    ...
    <title>DAR-AMIS | Asset Location</title>
    <style>
			...
			<div class="container-fluid">
                            <div class="panel panel-default">
                                             ...
                                             <div class="btn-group">
                                              <button class="btn btn-secondary dropdown-toggle" type="button" data-toggle="dropdown" id="reports"> 
                                                ...
                                                <ul class="dropdown-menu">
                                                  <li><a class="dropdown-item" id="1" href="#" >Asset Location</a></li>    	                       
                                                </ul>
                                            </div>
                                            </div> 
                                  ...
                                  <div class = "panel-heading panel-heading-custom">
                                    <div class= "row">
                                       <div class="col-sm-2"><label align= "text-center" id="one">Unit</label></div>
                                          ...
                                          <div class="col-sm-2"><label align= "text-center">Location</label></div>          
                                    </div>
                                  </div>
