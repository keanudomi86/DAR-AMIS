<%-- 
    ...
    Created on : 03 23, 18, 10:55:13 AM
...
<html lang="en">
  <head>
    ...
    <title>DAR-AMIS | Asset Acquisition</title>
    <style>
			...
			<div class="container-fluid">
                            <div class="panel panel-default">
                                           ...
                                           <div class="btn-group">
                                            <button class="btn btn-secondary dropdown-toggle" type="button" data-toggle="dropdown" id="reports"> 
                                              ...
                                              <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" id="1" href="#" >Asset Acquisition</a></li>    	                       
                                              </ul>
                                          </div>
                                          </div> 
                                ...
                                <div class = "panel-heading panel-heading-custom">
                                  <div class= "row">
                                     <div class="col-sm-2"><label align= "text-center" id="one">Property Number</label></div>
