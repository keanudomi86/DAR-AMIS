<%-- 
    Document   : disposal
    Created on : 03 23, 18, 11:15:08 AM
			...
			<div class="container-fluid">
                            <div class="panel panel-default">
                                             ...
                                             <div class="btn-group">
                                              <button class="btn btn-secondary dropdown-toggle" type="button" data-toggle="dropdown" id="reports"> 
                                                ...
                                                <ul class="dropdown-menu">
                                                  <li><a class="dropdown-item" id="1" href="#" >Disposal</a></li>    	                       
                                                </ul>
                                            </div>
                                            </div> 
                                  ...
                                  <div class = "panel-heading panel-heading-custom">
                                    <div class= "row">
                                       <div class="col-sm-2"><label align= "text-center" id="one">Article</label></div>
                                          ...
                                          <div class="col-sm-2"><label align= "text-center">Type of Disposal</label></div>              
                                    </div>
                                  </div>
