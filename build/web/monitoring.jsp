...
<html lang="en">
  <head>
    ...
    <title>DAR-AMIS | Monitoring</title>
  </head>
         ...
         <section id="main-content">
          <section class="wrapper">
              <section class="content-header">
                    <h1>
                        Welcome to the Monitoring Module!
                        <small>Choices</small>
                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
	                  	  	  <h4><i class="fa fa-angle-right"></i> Forms</h4>
	                  	  	  <hr>
                              <thead>
                              <tr>
                      ...
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
                              ...
                              <tr>
                                  ...
                                  <th class="hidden-phone"><i class="fa fa-question-circle"></i> Office</th>
